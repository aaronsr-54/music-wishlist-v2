...
export const ICON_REGISTRY: Record<IconName, string> = {
  ...
  send: `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 24 24" fill="none"><path d="M16.691 4.726L2.136 10.31a1 1 0 0 0 0 1.87l14.555 5.584a1 1 0 0 0 1.272-1.272l-5.584-14.555a1 1 0 0 0-1.272-1.272zM12 13a1 1 0 1 0 0-2 1 1 0 0 0 0 2z" fill="currentColor"/></svg>`,
};
