...
export const ICON_REGISTRY: Record<IconName, string> = {
  ...
  sun: `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="5" stroke="currentColor" stroke-width="1.5"/><path d="M12 1v6M12 17v6M23 12h-6M7 12H1M20.485 3.515L16.97 7.03M7.03 16.97L3.515 20.485M20.485 20.485L16.97 16.97M7.03 7.03L3.515 3.515" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>`,
  moon: `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 24 24" fill="none"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
};
