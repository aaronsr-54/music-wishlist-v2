...
export const ICON_REGISTRY: Record<IconName, string> = {
  ...
  eye: `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 24 24" fill="none"><path d="M12 5C7 5 2.73 8.11 1 12.46c1.73 4.35 6 7.54 11 7.54s9.27-3.19 11-7.54C21.27 8.11 17 5 12 5m0 9c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" fill="currentColor"/></svg>`,
  'eye-off': `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 24 24" fill="none"><path d="M11.83 9L5.59 2.75L4.17 4.17L19.83 20l1.41-1.41L15.17 15c2.36-1.53 4.29-3.89 5.57-6.54-1.73-4.35-6-7.54-11-7.54-2.36 0-4.62.7-6.5 1.88L11.83 9zM12 16c1.38 0 2.5-1.12 2.5-2.5v-.5l3 3v.5c0 2.76-2.24 5-5 5-1.24 0-2.38-.46-3.27-1.22l2.27-2.27v-.53z" fill="currentColor"/></svg>`,
};
