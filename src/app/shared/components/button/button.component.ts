...
const VARIANTS: Record<ButtonVariant, string> = {
  add: `${BASE} border-none bg-transparent rounded-full shrink-0 text-ink-600 dark:text-bone-600 w-[clamp(2.25rem,5vw,2.75rem)] h-[clamp(2.25rem,5vw,2.75rem)] hover:bg-bone-700 dark:hover:bg-ink-200 hover:text-bone-100 active:scale-[0.82]`,
